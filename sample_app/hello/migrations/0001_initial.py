# Generated by Django 4.2 on 2024-06-03 01:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ManyToManyField(to='hello.author', verbose_name='著者')),
                ('publisher', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hello.publisher', verbose_name='出版社')),
            ],
            options={
                'db_table': 'books',
            },
